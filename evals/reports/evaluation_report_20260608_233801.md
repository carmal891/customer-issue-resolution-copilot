...
**Date:** June 08, 2026  
**Evaluation Run:** 20260608_233801  
...
|--------|-------------|--------|--------|--------|
| **Faithfulness** | Answer is based on retrieved documents (no hallucination) | ≥85% | 97.6% | ✅ |
| **Answer Relevancy** | Answer directly addresses the question | ≥90% | 92.0% | ✅ |
...
- **Pass Rate:** 1/2 (50%)
- **Avg Faithfulness:** 99.0%
- **Avg Answer Relevancy:** 88.0%
- **Avg Context Precision:** 100.0%
...
- **Avg Confidence (Correct):** 0.34
- **Avg Confidence (Incorrect):** 0.30

### Results by Category


#### Booking Issues (6 tests) ✅
...
- **Booking Skill Matching:** 100% accuracy (6/6 tests passed)
- **RAG Faithfulness:** 97.6% (no hallucinations)

### ⚠️ What Needs Improvement

- **Knowledge Base RAG:** Only 60% pass rate (target: 85%+)
- **Billing Skill Matching:** Only 0% accuracy (target: 90%+)
- **Amenity Skill Matching:** Only 50% accuracy (target: 90%+)
- **Confidence Calibration:** Low confidence (0.34) even when correct
...
- Current confidence: 0.34 (low even when correct)
- Actions:
...
**Report Generated:** 2026-06-08 23:38:01  
**Evaluation Framework Version:** 1.0  
**Results Files:**
- `evals/results/kb_rag_20260608_233801.json`
- `evals/results/skill_matching_20260608_233801.json`
