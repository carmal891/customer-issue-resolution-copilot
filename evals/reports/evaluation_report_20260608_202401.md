...
**Date:** June 08, 2026  
**Evaluation Run:** 20260608_202401  
**System Version:** v1.0
...
|--------|-------------|--------|--------|--------|
| **Faithfulness** | Answer is based on retrieved documents (no hallucination) | ≥85% | 99.6% | ✅ |
| **Answer Relevancy** | Answer directly addresses the question | ≥90% | 91.6% | ✅ |
...
- **Pass Rate:** 2/3 (67%)
- **Avg Faithfulness:** 99.3%
- **Avg Answer Relevancy:** 96.0%
...
- **RAG Faithfulness:** 99.6% (no hallucinations)
...
**Report Generated:** 2026-06-08 20:24:01  
**Evaluation Framework Version:** 1.0  
**Results Files:**
- `evaluations/results/kb_rag_20260608_202401.json`
- `evaluations/results/skill_matching_20260608_202401.json`
